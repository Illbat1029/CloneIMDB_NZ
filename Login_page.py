...
"}")
        ...
        self.Central_widget.setMaximumSize(QtCore.QSize(1000, 600))
        ...
        self.stackedWidget.setMinimumSize(QtCore.QSize(300, 420))
        self.stackedWidget.setMaximumSize(QtCore.QSize(300, 405))
        ...
        self.bttn_forgort = QtWidgets.QPushButton(self.login)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bttn_forgort.sizePolicy().hasHeightForWidth())
        self.bttn_forgort.setSizePolicy(sizePolicy)
        self.bttn_forgort.setMinimumSize(QtCore.QSize(0, 40))
        self.bttn_forgort.setMaximumSize(QtCore.QSize(16777215, 40))
        self.bttn_forgort.setObjectName("bttn_forgort")
        self.verticalLayout_4.addWidget(self.bttn_forgort)
